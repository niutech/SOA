...
namespace Service\GithubBundle\Tests\Controller;
...
class SearchControllerTest extends WebTestCase
{
    ...
    /**
     * @var Service\GithubBundle\Tests\Controller\Client
     */
    private $_client;
    ...
    public function indexActionWithNoParameters()
    {
        ...
        $this->assertEquals('{"success":false,"message":null,"language":"","results":[],"query":"q=&language="}', $this->_client->getResponse()->getContent());
    }
