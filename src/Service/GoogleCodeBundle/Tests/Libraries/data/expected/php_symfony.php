<?php $php_symfony = array (
  0 => 
  array (
    'title' => 'gapi-google-analytics-php-interface &nbsp;- &nbsp;GAPI - Google Analytics API PHP Interface',
...
Developme...',
  ...
  2 => 
  array (
    'title' => 'mysql-workbench-doctrine-plugin &nbsp;- &nbsp;plugin to create YAML schemes out of MySQL Workbench for the doctrine ...',
    'url' => 'http://code.google.com/p/mysql-workbench-doctrine-plugin/',
...
1. I&#39;m a PHP developer and LUA is a pain for me, as it retains me from implementing good ideas. The second effect is, that users ...',
  ...
  3 => 
  array (
    'title' => 'sabreamf &nbsp;- &nbsp;SabreAMF is a Flash Remoting server and client for PHP',
    'url' => 'http://code.google.com/p/sabreamf/',
...
The sourcecode has been moved to  Github, where it can be freely forked. If somebody who cares enough steps up, I&#39;ll hap...',
  ...
  4 => 
  array (
    'title' => 'spyc &nbsp;- &nbsp;A simple YAML loader/dumper class for PHP',
...
Spyc is a YAML loader/dumper written in pure PHP. Given a YAML document, Spyc will return an array which you can use however you see fit. Given an array, Spyc will r...',
  ...
  5 => 
  array (
    'title' => 'yamleditor &nbsp;- &nbsp;Eclipse YAML Editor plugin',
    'url' => 'http://code.google.com/p/yamleditor/',
    'code' => 'Instalation via Update Manager: 
   URL:  (NEW)
...
You can  entry issue, to report bug, request new features or suggest modifications to existing features.',
  ...
  7 => 
  array (
    'title' => 'kohana-mptt &nbsp;- &nbsp;Kohana Code Repository',
    'url' => 'http://code.google.com/p/kohana-mptt/',
    'code' => 'I won&#39;t have time in the near future to do bugfixes, new features etc. Feel free to fork any of the stuff in this repo with attribution. 
