<?php $perl_irc = array (
  ...
  1 => 
  array (
    'title' => 'slimrat &nbsp;- &nbsp;One-click hosters downloader for Linux',
    'url' => 'http://code.google.com/p/slimrat/',
    'code' => 'Slimrat is a command-line and graphical application for automated downloading from file hosters like Rapidshare, Megaupload, Depositfiles and many more. The current version is 1.0.
...
Please hel...',
  ...
  2 => 
  array (
    'title' => 'tircd &nbsp;- &nbsp;tircd presents twitter as an irc channel. You can connect to tircd wit...',
...
...',
  ...
  3 => 
  array (
    'title' => 'camelbox &nbsp;- &nbsp;A build of Perl with Gtk+, packaged and ready for use on 32-bit Window...',
    'url' => 'http://code.google.com/p/camelbox/',
    'code' => 'A complete build of Perl for 32-bit Windows that includes:
  ...
  4 => 
  array (
    'title' => 'casper-3 &nbsp;- &nbsp;Tastyllama CRS',
    'url' => 'http://code.google.com/p/casper-3/',
...
It is - essentially - a bot which performs administration tasks within an IRC channel, such as opping, voicing, maintaining a kic...',
  ...
  9 => 
  array (
    'title' => 'irssi-game-scripts &nbsp;- &nbsp;自己制作的，自以为很好玩的 Irssi 脚本，以及一些乱七八糟的文件备份',
    'url' => 'http://code.google.com/p/irssi-game-scripts/',
